...
export default function NewClient() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // B. (선택) 서류 업로드 처리 - 현재는 mock_url 처리 (필요시 uploadFileToS3 사용 가능)
      // 실제 구현 시에는 docs 파일들도 uploadFileToS3를 태우면 됩니다.
      ...
      const payload = {
        ...
        lat: 37.4979, // 임시 좌표 (추후 주소 검색 연동 필요)
        lng: 127.0276,
        images: uploadedImageUrls,
        // 서류 URL 처리 (파일이 있으면 임시 문자열 전송)
