...
function AnalysisMap({ showPopulation, showCompetitors }) {
    ...
    const [isMapLoaded, setIsMapLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // 지도 로드 상태 관리
    // 지도 초기화 함수
    const initMap = ()=>{
