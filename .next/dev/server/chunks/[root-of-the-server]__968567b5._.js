...
async function GET(req) {
    ...
    if (mine) {
        ...
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].listing.findMany({
            where: {
...
async function POST(req) {
    ...
    const { title, category, address_area, deposit, rent_monthly, goodwill_price, monthly_sales, parking_spaces, lat, lng, photos } = body ?? {};
    if (!title) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
    ...
    const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].listing.create({
        data: {
            title,
            category: category ?? null,
            address_area: address_area ?? null,
            deposit: deposit ?? null,
            rent_monthly: rent_monthly ?? null,
            goodwill_price: goodwill_price ?? null,
            monthly_sales: monthly_sales ?? null,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__968567b5._.js.map