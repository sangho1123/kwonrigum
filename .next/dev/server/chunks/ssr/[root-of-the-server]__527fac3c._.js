...
params }) {
    ...
    // 메모리 기반 override 반영
    const override = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getProofStatus"])(Number(id));
    ...
    // 지도용 아이템 (proof_status를 vm 기준으로 통일)
    const mapItems = [
        {
            id: vm.id,
            title: vm.title,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__527fac3c._.js.map