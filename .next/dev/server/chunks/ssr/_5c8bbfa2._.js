module.exports = [
"[project]/lib/mockAnalysis.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/AnalysisMap.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mockAnalysis$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/mockAnalysis.ts [app-ssr] (ecmascript)");
...
function AnalysisMap({ showPopulation, showCompetitors }) {
    ...
    const overlaysRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])([]);
    const [isMapLoaded, setIsMapLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false); // 지도 로드 상태 관리
    // 지도 초기화 함수
    const initMap = ()=>{
        // 1. 방어 코드: 요소가 없거나, 네이버 객체가 없으면 중단
        if (!mapElement.current || !window.naver || !window.naver.maps) {
            return;
        }
        // 이미 지도가 그려져 있다면 중복 생성 방지
    ...
    const updateOverlays = ()=>{
        ...
        // 유동인구 히트맵
        if (showPopulation) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mockAnalysis$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["POPULATION_DENSITY"].forEach((data)=>{
        ...
        // 경쟁 업체 마커
        if (showCompetitors) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mockAnalysis$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["COMPETITOR_STORES"].forEach((store)=>{
    ...
    // 2. 이미 스크립트가 로드된 상태(Nav 이동 등)라면 즉시 초기화
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (window.naver && window.naver.maps) {
            initMap();
        }
    }, []);
    // 3. 지도가 로드되거나 옵션이 바뀌면 오버레이 다시 그리기
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (isMapLoaded) {
            updateOverlays();
        }
...
"[project]/app/analysis/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AnalysisMap$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/AnalysisMap.tsx [app-ssr] (ecmascript)"); // 👈 기존 지도 컴포넌트 불러오기
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mockAnalysis$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/mockAnalysis.ts [app-ssr] (ecmascript)");
...
function AnalysisPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mockAnalysis$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockAnalysisData"])(address, category);
        setData(result);
    }, [
        address,
        category
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AnalysisMap$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                lat: data.lat,
                                lng: data.lng
                            }, void 0, false, {
                                fileName: "[project]/app/analysis/page.tsx",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "* 반경 내 원형 표시는 유동인구 및 핵심 상권을 나타냅니다."
                        }, void 0, false, {
                            fileName: "[project]/app/analysis/page.tsx",
                            lineNumber: 67,
                            columnNumber: 11
...
//# sourceMappingURL=_5c8bbfa2._.js.map